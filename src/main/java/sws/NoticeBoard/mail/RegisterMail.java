...
public class RegisterMail implements MailServiceInter {
  ...
  @Autowired JavaMailSender emailSender; // MailConfig에서 등록해둔 Bean을 autowired하여 사용하기

  private String ePw; // 사용자가 메일로 받을 인증번호

  // 메일 내용 작성
  @Override
  public MimeMessage creatMessage(String to)
    ...
    message.setSubject("[NoticeBoard] 회원 가입을 위한 이메일 인증코드 입니다"); // 이메일 제목

    String msgg = "";
    // msgg += "<img src=../resources/static/image/emailheader.jpg />"; // header image
    msgg += "<h1>안녕하세요</h1>";
    msgg += "<h1>NoticeBoard 입니다</h1>";
    msgg += "<br>";
    ...
    message.setFrom(new InternetAddress(naverId + "@naver.com", "sws"));
