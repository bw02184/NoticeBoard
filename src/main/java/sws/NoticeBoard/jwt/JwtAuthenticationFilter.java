...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			if (memberLoginId != null) {
				...
				LocalDateTime localDateTime = LocalDateTime.ofInstant(expirationDateFromToken.toInstant(),
	...
	private String expiredAccessTokenToRegenerateToken(HttpServletResponse response, String loginId) throws
